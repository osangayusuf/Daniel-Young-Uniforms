        ...
        <div class="w-11/12 mt-16 ml-4">
            ...
            <div>
                ...
                <div class="w-[89%] max-md:w-[70%] mx-auto">
                    <h1 class="text-4xl max-md:text-2xl max-md:text-center font-bold my-20">Edit by Category</h1>
                    <div class="grid grid-cols-2 max-md:grid-cols-1 gap-3 text-whiteish font-semibold max-md:text-base text-lg">
                        @foreach($categories as $category)
                            <a href="{{ route('admin.products') . '?category=' . $category->id }}" class="relative block w-full">
