    ...
    <form action="{{ route('cart.store') }}" method="post" enctype="multipart/form-data" class="text-xs lg:text-base">
        ...
        <div class="pt-8 space-y-2">
            <div class="flex flex-col gap-2">
                ...
                <input type="number" name="quantity" id="quantity" value="{{ old('quantity') }}" placeholder="1" class="border border-dark-gray w-1/2 lg:w-24 rounded-sm flex items-center justify-center">
                @error('quantity')
                <p class="text-red-500 italic text-xs lg:text-sm">
                    {{ $message }}
                </p>
        ...
        <div class="space-y-2 mt-8">
            ...
            <input type="text" name="chest_size" id="chest_size" placeholder="48" value="{{ old('chest_size') }}" class="block w-full lg:w-96 h-10 pl-3 border border-light-gray rounded">
            @error('chest_size')
            <p class="text-red-500 italic text-xs lg:text-sm">
                {{ $message }}
            </p>
        ...
        <div class="space-y-2 mt-8">
            ...
            <input type="text" name="arm_length" id="arm_length" placeholder="60" value="{{ old('arm_length') }}" class="block w-full lg:w-96 h-10 pl-3 border border-light-gray rounded">
            @error('arm_length')
            <p class="text-red-500 italic text-xs lg:text-sm">
                {{ $message }}
            </p>
        ...
        <div class="space-y-2 mt-8">
            ...
            <input type="text" name="neck_size" id="neck_size" placeholder="48" value="{{ old('neck_size') }}" class="block w-full lg:w-96 h-10 pl-3 border border-light-gray rounded">
            @error('neck_size')
            <p class="text-red-500 italic text-xs lg:text-sm">
                {{ $message }}
            </p>
        ...
        <div class="space-y-2 mt-8">
            ...
            <input type="text" name="waist_size" id="waist_size" placeholder="60" value="{{ old('waist_size') }}" class="block w-full lg:w-96 h-10 pl-3 border border-light-gray rounded">
            @error('waist_size')
            <p class="text-red-500 italic text-xs lg:text-sm">
                {{ $message }}
            </p>
        ...
        <div class="space-y-2">
            ...
            <textarea type="text" name="further_info" id="further_info" placeholder="Enter Text" class="block w-full relative h-[194px] py-2 px-2 rounded">{{ old('further_info') }}</textarea>
            @error('further_info')
            <p class="text-red-500 italic text-xs lg:text-sm">
                {{ $message }}
            </p>
        ...
        <button type="submit" class="bg-dark-blue text-whiteish px-3 py-3 w-full lg:w-[552px] rounded-lg mt-20 lg:ml-6">Add to Cart</button>
    </form>
